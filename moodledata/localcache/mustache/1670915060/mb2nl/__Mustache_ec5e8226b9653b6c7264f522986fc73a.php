...
class __Mustache_ec5e8226b9653b6c7264f522986fc73a extends Mustache_Template
{
...
';
        $buffer .= $indent . '    <div class="loginleft">
';
        $buffer .= $indent . '        <h2 class="login-heading h3">';
        // 'str' section
...
';
        ...
        $buffer .= $this->section95a31bbbd1fd870e0c25706c7eee204a($context, $indent, $value);
        $buffer .= $indent . '        <div class="login-form-wrap">
';
...
';
        ...
        $buffer .= '">
';
        $buffer .= $indent . '                <div class="login-form-username form-group form-item">
';
...
';
        $buffer .= $indent . '                </div>
';
        $buffer .= $indent . '                <div class="login-form-password form-group form-item">
';
...
';
        $buffer .= $indent . '                </div>
';
        $buffer .= $indent . '                <div class="login-form-forgotpassword form-item">
';
...
';
        $buffer .= $indent . '                </div>
';
        $buffer .= $indent . '                <div class="login-form-submit form-item">
';
        $buffer .= $indent . '                    <button class="btn btn-primary fw1" type="submit" id="loginbtn">';
        // 'str' section
        $value = $context->find('str');
        $buffer .= $this->sectionB15dee8971ab065bf4d6402b60d852be($context, $indent, $value);
        $buffer .= '</button>
...
';
        ...
        $buffer .= $this->section964cba841ab7a6c4b744a23296244e3d($context, $indent, $value);
        $buffer .= $indent . '        <div class="cookies-notice">
';
        $buffer .= $indent . '            <span>';
        // 'str' section
        $value = $context->find('str');
        $buffer .= $this->section8d3d35973869b9b27aeaf06577a753c6($context, $indent, $value);
        $buffer .= '. </span>
';
        $buffer .= $indent . '            <a href="#" class="themereset" ';
...
';
        $buffer .= $indent . '
';
        $buffer .= $indent . '    <div class="loginright">
';
        // 'hasinstructions' section
        $value = $context->find('hasinstructions');
        $buffer .= $this->section397cbbe8996c98489e9c461d8894a9a3($context, $indent, $value);
        // 'cansignup' section
        $value = $context->find('cansignup');
        $buffer .= $this->sectionAc6ddbddeba89eb1da04434811841024($context, $indent, $value);
        $buffer .= $indent . '    </div>
';
        $buffer .= $indent . '</div>
';
...
';
    ...
    private function sectionB0a7075f51475c8001c5323289845e33(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        ...
        if (!is_string($value) && is_callable($value)) {
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $indent . '                            <span class="btn-image" aria-hidden="true">
';
...
';
    ...
    private function section80745c29d740c85e902c53e1585813b9(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    
        if (!is_string($value) && is_callable($value)) {
            $source = ' continuewith, theme_mb2nl, {{name}} ';
            $result = call_user_func($value, $source, $this->lambdaHelper);
            if (strpos($result, '{{') === false) {
                $buffer .= $result;
            } else {
            ...
            foreach ($values as $value) {
                ...
                $buffer .= ' continuewith, theme_mb2nl, ';
    ...
    private function section924c797f0bdd1b399977363056e5abb2(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
                $buffer .= $indent . '                    <a class="btn btn-socimage btn-';
                $value = $this->resolveValue($context->find('name'), $context);
                $buffer .= call_user_func($this->mustache->getEscape(), $value);
                $buffer .= '" href="';
...
';
                ...
                $buffer .= $this->sectionB0a7075f51475c8001c5323289845e33($context, $indent, $value);
                $buffer .= $indent . '                        <span class="btn-text">
';
                $buffer .= $indent . '                            ';
                // 'str' section
                $value = $context->find('str');
                $buffer .= $this->section80745c29d740c85e902c53e1585813b9($context, $indent, $value);
                $buffer .= '
';
                $buffer .= $indent . '                        </span>
';
...
';
    ...
    private function sectionC511fd34720bd3ce6e8f77ec5285adb9(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    
        if (!is_string($value) && is_callable($value)) {
            $source = 'or, availability';
            $result = call_user_func($value, $source, $this->lambdaHelper);
            if (strpos($result, '{{') === false) {
                $buffer .= $result;
            } else {
    ...
    private function section95a31bbbd1fd870e0c25706c7eee204a(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
                $buffer .= $indent . '                <h2 class="login-heading sr-only">';
                // 'str' section
                $value = $context->find('str');
...
';
                ...
                $buffer .= $this->section924c797f0bdd1b399977363056e5abb2($context, $indent, $value);
                $buffer .= $indent . '            </div>
';
                $buffer .= $indent . '            <div class="text-separator"><div><span>';
                // 'str' section
                $value = $context->find('str');
                $buffer .= $this->sectionC511fd34720bd3ce6e8f77ec5285adb9($context, $indent, $value);
                $buffer .= '</span></div></div>
';
                $context->pop();
            }
...
';
    ...
    private function section964cba841ab7a6c4b744a23296244e3d(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        ...
        if (!is_string($value) && is_callable($value)) {
            ...
            <div class="guest-login-form mb-2">
                ...
                <form action="{{loginurl}}" method="post" id="guestlogin" class="d-inline">
                    ...
                    <button class="btn btn-success" type="submit">{{#str}}loginguest{{/str}}</button>
                </form>
            </div>
        ';
            $result = call_user_func($value, $source, $this->lambdaHelper);
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $indent . '            <div class="guest-login-form mb-2">
';
...
';
                ...
                $value = $this->resolveValue($context->find('loginurl'), $context);
                $buffer .= call_user_func($this->mustache->getEscape(), $value);
                $buffer .= '" method="post" id="guestlogin" class="d-inline">
';
                $buffer .= $indent . '                    <input type="hidden" name="logintoken" value="';
                $value = $this->resolveValue($context->find('logintoken'), $context);
                $buffer .= call_user_func($this->mustache->getEscape(), $value);
...
';
                $buffer .= $indent . '                    <button class="btn btn-success" type="submit">';
                // 'str' section
                $value = $context->find('str');
...
';
    ...
    private function section8d3d35973869b9b27aeaf06577a753c6(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    ...
    private function section397cbbe8996c98489e9c461d8894a9a3(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function section68dbc1ad9647f878a388f8fb0c9ab2fc(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    ...
    private function sectionAc6ddbddeba89eb1da04434811841024(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    
        if (!is_string($value) && is_callable($value)) {
            $source = '
        <div class="login-form-newaccount form-item">
            {{#str}}loginsteps{{/str}} <a href="{{signupurl}}">{{#str}}startsignup{{/str}}</a>.
        </div>
        ';
            $result = call_user_func($value, $source, $this->lambdaHelper);
            if (strpos($result, '{{') === false) {
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $indent . '        <div class="login-form-newaccount form-item">
';
                $buffer .= $indent . '            ';
                // 'str' section
                $value = $context->find('str');
                $buffer .= $this->section68dbc1ad9647f878a388f8fb0c9ab2fc($context, $indent, $value);
                $buffer .= ' <a href="';
                $value = $this->resolveValue($context->find('signupurl'), $context);
                $buffer .= call_user_func($this->mustache->getEscape(), $value);
                $buffer .= '">';

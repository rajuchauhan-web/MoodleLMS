...
class __Mustache_8477207768a228762086905b8a2785c3 extends Mustache_Template
{
...
';
                ...
                // 'hiddenfromstudents' inverted section
                $value = $context->find('hiddenfromstudents');
                if (empty($value)) {
